...
import pytest
from reggie.db.repositories.comment_statistics_repository import CommentStatisticsRepository
...
class TestStatisticsSorting:
    ...
    @pytest.fixture
    def repo(self):
        """Create a repository instance for testing sorting logic."""
        # Pass None as connection since _sort_breakdown_for_visualization doesn't use it
        return CommentStatisticsRepository(None)

    def test_sort_breakdown_sentiment_fixed_order(self, repo):
        ...
        sorted_breakdown = repo._sort_breakdown_for_visualization(
            breakdown, "sentiment"
        )
    ...
    def test_sort_breakdown_category_alphabetical(self, repo):
    ...
    def test_sort_breakdown_topic_alphabetical(self, repo):
    ...
    def test_sort_breakdown_case_insensitive(self, repo):
    ...
    def test_sort_breakdown_sentiment_case_insensitive(self, repo):
    ...
    def test_sort_breakdown_unknown_sentiment_goes_last(self, repo):
    ...
    def test_sort_breakdown_empty_list(self, repo):
    ...
    def test_sort_breakdown_single_item(self, repo):
